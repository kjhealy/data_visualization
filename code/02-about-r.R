...
## ----02-about-r-26, eval=FALSE------------------------------------------------
## help(mean)


## ----02-about-r-27, eval = FALSE----------------------------------------------
## ## quicker
## ?mean
...
## ----02-about-r-42, message = FALSE, echo = FALSE-----------------------------
...
## ----codefig-plot-2, message=FALSE, fig.show="hide", fig.width=5.8, fig.height=5.5----
library(tidyverse)
library(gapminder)
...
## ----02-about-r-67, echo=FALSE------------------------------------------------
knitr::include_graphics(
  knitr::fig_chunk("codefig-plot-2", "png")
)


## ----02-about-r-68, message=FALSE, eval = FALSE, echo = TRUE------------------
## library(tidyverse)
## 
## library(gapminder)


## ----02-about-r-69, message=FALSE, eval = FALSE, echo = TRUE------------------
## 
## p <- ggplot(data = gapminder,
##             mapping = aes(x = gdpPercap,
##                           y = lifeExp))
...
## ----02-about-r-70, message=FALSE, eval = FALSE, echo = TRUE------------------
## 
## 
## p + geom_point()
## 
