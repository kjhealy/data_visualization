...
date: "`Code Horizons, January 2022`"
...
The course packet will be available before the course begins. It is an RStudio project containing PDFs of the slides for the course together with code for almost all of the graphs we will draw, and some additional datasets and other material. After you have installed R and RStudio, [download the course packet](https://github.com/kjhealy/dataviz_0122/archive/refs/heads/main.zip) and uncompress it on your computer. Double-clicking the file named `dataviz.Rproj` should launch the project in RStudio.
