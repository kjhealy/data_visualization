...
```{r 05-work-with-dplyr-and-geoms-2 }
gss_sm  
```
...
```{r 05-work-with-dplyr-and-geoms-3, echo=FALSE}
gss_sm |> 
...
```{r 05-work-with-dplyr-and-geoms-4, echo = FALSE}
...
```{r 05-work-with-dplyr-and-geoms-5, echo = FALSE}
...
```{r 05-work-with-dplyr-and-geoms-6 }
gss_sm
```
...
```{r 05-work-with-dplyr-and-geoms-8 }
...
```{r 05-work-with-dplyr-and-geoms-30, fig.width=10, fig.height=5}
...
```{r 05-work-with-dplyr-and-geoms-31, fig.width=8, fig.height=5.5}
p <-  ggplot(data = gss_sm,
             mapping = aes(x = age, y = childs))
...
```{r 05-work-with-dplyr-and-geoms-32, fig.width=15, fig.height=5.5}
p <-  ggplot(data = gss_sm,
             mapping = aes(x = age, y = childs))
...
```{r 05-work-with-dplyr-and-geoms-33, fig.width=11, fig.height=6.5, warning = FALSE}
p + geom_point(alpha = 0.2) + 
  geom_smooth() +
  facet_grid(sex ~ race) #<< 
...
```{r 05-work-with-dplyr-and-geoms-34, fig.width=11, fig.height=6.5, warning = FALSE}
...
```{r 05-work-with-dplyr-and-geoms-35, echo=FALSE, warning=FALSE, fig.width=12, fig.height=8}
p_out
```
...
```{r 05-work-with-dplyr-and-geoms-36 }
gss_sm |> 
  group_by(bigregion, religion) |> 
  tally() |> 
  mutate(freq = n / sum(n),
...
```{r 05-work-with-dplyr-and-geoms-41, fig.width=21, fig.height=8}
p <- ggplot(data = organdata,
            mapping = aes(x = year, y = donors))
p + geom_line() + 
