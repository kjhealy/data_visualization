...
# .huge[[Piece by piece,]{.fg-yellow}<br/>[Layer by layer]{.fg-lblue}]
...
# .huge[[More about Scales]{.fg-lblue}]
...
---
`r chunq_reveal("reveal-scalemanual",  lcolw="40", rcolw="60", title = "# You can always specify scales manually")`
...
---
`r chunq_reveal("reveal-scalemanual4",  lcolw="40", rcolw="60", title = "# You can always specify scales manually")`
...
- - .center.large[[`scale\\\_`]{.fg-green}[`<MAPPING>`]{.fg-orange}[`\\\_`]{.fg-green}[`<KIND>`]{.fg-lblue}[`\\\_`]{.fg-green}[`<COLORSCALE>`]{.fg-pink}[`()`]{.fg-green}]
...
## .huge.right.bottom.squish4[[Layer color and text<br />]{.fg-yellow}[to your advantage]{.fg-lblue}]
...
# .middle.squish4.large[[Leverage ggplot's]{.fg-orange}<br />[layered approach]{.fg-lblue}]
...
# .middle.squish4.large[[Layer,]{.fg-lblue}<br />[Highlight,]{.fg-pink}<br />[Repeat]{.fg-lblue}]
...
![](img/08_status_conceptual.png)

---

# Build from ideas to data

![](img/08_status_hypotheses.png)
...
![](img/08_status_results.png)

---

# Repeat to [differentiate]{.fg-lblue}

![](img/08_model_controls_pointrange_IRRs_MASSnb.png)
...
![](img/08_mode_lsm_nb_gender_journal.png)

---

# Layer and repeat with [facets]{.fg-lblue}

![](img/08_growth_curve_quantile_quantreg_gender.png)

---

# Layer and repeat [across]{.fg-lblue} facets

![](img/08_altservices.png)

---

# Layer and repeat [across]{.fg-lblue} facets

![](img/08_altservices2.png)
...
- .medium[are controlled by the [`theme()`]{.fg-green} function]

- .medium[can be bundled into functions of their own, like [`theme_bw()`]{.fg-green} or [`theme_minimal()`]{.fg-green}]

- .medium[can be set for the duration of a file or project with [`theme_set()`]{.fg-green}]
...
# .middle.squish4.large[Thematic elements do not represent data directly]{.fg-orange}
...
.pull-right.w55[
```{r}
#| label: "08-polishing-and-presenting-plots-26"
#| echo: FALSE
...
.pull-right.w55[
```{r}
#| label: "08-polishing-and-presenting-plots-27"
#| echo: FALSE
  knitr::include_graphics(
...
.pull-right.w55[
```{r}
#| label: "08-polishing-and-presenting-plots-28"
#| echo: FALSE
  knitr::include_graphics(
...
.pull-right.w55[
```{r}
#| label: "08-polishing-and-presenting-plots-29"
#| echo: FALSE
  knitr::include_graphics(
...
.pull-right.w55[
```{r}
#| label: "08-polishing-and-presenting-plots-30"
#| echo: FALSE
  knitr::include_graphics(
...
.pull-right.w55[
```{r}
#| label: "08-polishing-and-presenting-plots-31"
#| echo: FALSE
  knitr::include_graphics(
...
.pull-right.w55[
```{r}
#| label: "08-polishing-and-presenting-plots-32"
#| echo: FALSE
  knitr::include_graphics(
...
## .huge.right.bottom.squish4[[The]{.fg-yellow} [`ggthemes`]{.fg-lblue} [package]{.fg-yellow}]
...
.medium[See how the full function call goes inside [`theme_set()`]{.fg-green}, including the parentheses, because we are actually running that function to set all the elements.] 
...
# .middle.squish4.large[[Pick a theme]{.fg-lblue}<br/> [and stick with it]{.fg-orange}]
