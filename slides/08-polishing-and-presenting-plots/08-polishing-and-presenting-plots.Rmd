...
```{r 08-polishing-and-presenting-plots-5, echo = FALSE}
...
```{r 08-polishing-and-presenting-plots-6, echo = FALSE, fig.height=5.5, fig.width=7}
...
```{r 08-polishing-and-presenting-plots-7, echo = FALSE, fig.height=5.5, fig.width=4}
par(mar=c(0,4,0,0))
...
```{r 08-polishing-and-presenting-plots-8, echo = FALSE, fig.height=5.5, fig.width=6}
par(mar=c(0,4,0,0))
...
```{r 08-polishing-and-presenting-plots-9, eval = FALSE, fig.show="hold", out.width="50%"}
p + geom_point(size = 2) + 
...
.pull-left[
```{r 08-polishing-and-presenting-plots-10, echo = FALSE, fig.height=4, fig.width=6}
p + geom_point(size = 3) + 
  scale_color_brewer(palette = "Set2") +
  labs(title = "Set2")
```

```{r 08-polishing-and-presenting-plots-11, echo = FALSE, fig.height=4, fig.width=6}
p + geom_point(size = 3) + 
  scale_color_brewer(palette = "Pastel2") +
  labs(title = "Pastel2")
```
...
.pull-right[
```{r 08-polishing-and-presenting-plots-12, echo = FALSE, fig.height=4, fig.width=6}
p + geom_point(size = 3) + 
  scale_color_brewer(palette = "Dark2") +
  labs(title = "Dark2")
```

```{r 08-polishing-and-presenting-plots-13, echo = FALSE, fig.height=4, fig.width=6}
p + geom_point(size = 3) + 
  scale_color_brewer(palette = "Accent") +
  labs(title = "Accent")
```
...
```{r 08-polishing-and-presenting-plots-14, fig.height = 8, fig.width = 16, echo = FALSE}
