...
# .huge[[Working and]{.fg-yellow}<br/>[Reworking]{.fg-lblue}]

---

class: right bottom main-title section-title-1

## .huge.right.bottom.squish4[[Two y-axes]{.fg-yellow}]
...
## .huge.right.bottom.squish4[[Redrawing]{.fg-yellow} [a bad slide]{.fg-lblue}]

---

layout: false

![](img/09_yahoo_headcount.png)
...
## .huge.right.bottom.squish4[[Say no]{.fg-yellow} [to pie]{.fg-lblue}]

---

# Pie charts are easy to mess up

![](img/09_student_debt_pie.png)
...
`r chunq_reveal("reveal-debtalt",  lcolw="40", rcolw="60", title = "# Alternatively, as a kind of stacked bar chart")`
...
# .huge[[But I want]{.fg-lblue}<br /> [a pony]{.fg-yellow}]
...
![](img/09_show_pony_pbe_by_school_type_bee.png)

---

# Show ponies

![](img/09_show_pony_france_blackposter.png)
...
![](img/09_okboomer2_composite_poster-200-01-2.png)
...
## .huge.right.bottom.squish4[[OK]{.fg-yellow} [boomer]{.fg-lblue}]
...
## .huge.right.bottom.squish4[[Beeswarms and]{.fg-yellow}<br />[bespoke labels]{.fg-lblue}]
...
.right.w90.small[Vaccination Exemptions in California Kindergartens]
