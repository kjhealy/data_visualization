...
## .huge.right.bottom.squish4[.kjh-yellow[Beeswarms and]<br />.kjh-lblue[bespoke labels]]
...
# The .kjh-lblue[`cavax`] package

```{r 09-case-studies-18 }
...
---
`r chunk_reveal("reveal-auxinfo", widths = c(50,50), title = "# Aux Info Panel")`

```{r reveal-auxinfo, include = FALSE}
library(ggbeeswarm)
...
---
`r chunk_reveal("reveal-auxinfo2", widths = c(50,50), title = "# A little kludge")`

```{r reveal-auxinfo2, include = FALSE}
...
```{r 09-case-studies-19, echo = FALSE}
kjh_set_classic_theme()
theme_set(theme_minimal())
```

---
`r chunk_reveal("reveal-beemain", widths = c(50,50), title = "# At last, the Beeplot")`

```{r reveal-beemain, include = FALSE}
cavax |> 
...
```{r 09-case-studies-20, echo = FALSE, fig.height = 8, fig.width=15}
p_bee_main
```
