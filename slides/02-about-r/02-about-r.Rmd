...
.center[![:scale 90% "Covid example"](img/02_lorem_covid_markdown.png)]  
...
.SMALL[Read this operator as "_.kjh-pink[**and then**]_"]
...
.small[Underneath, most complex R objects are some kind of list with different components.]
