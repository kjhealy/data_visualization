...
# Aside 2: Logic and floating point arithmetic
...
# .huge.squish4[More later on why this might bite you, and how to deal with it]
...
- The pipe operator .kjh-pink[**`|>`**] was not part of Base R until very recently. Pipling was originally introduced in a package called `magrittr`, where it was written `%>%` and behaved in very nearly* the same was as the base pipe now does. 
