...
`r chunq_reveal("reveal-asasteps",  lcolw="60", rcolw="40", smallcode = TRUE, title = "Build your plots a piece at a time")`
...
`r chunq_reveal("reveal-scalemanual",  lcolw="60", rcolw="40", smallcode = TRUE, title = "You can specify scales manually")`
...
`r chunq_reveal("reveal-scalemanual2",  lcolw="60", rcolw="40", smallcode = TRUE, title = "You can always specify scales manually")`
...
`r chunq_reveal("reveal-scalemanual3",  lcolw="60", rcolw="40", smallcode = TRUE, title = "You can always specify scales manually")`
...
`r chunq_reveal("reveal-scalemanual4",  lcolw="60", rcolw="40", smallcode = TRUE, title = "You can specify scales manually")`
...
`r chunq_reveal("reveal-fliptrump",  lcolw="60", rcolw="40", smallcode = TRUE, title = "We know how to build this")`
...
# [T]{.fg-lblue}[h]{.fg-yellow}[e]{.fg-pink}[m]{.fg-green}[e]{.fg-orange}.kjh-grey[s]
