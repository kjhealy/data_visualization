...
- Remember, we can layer geoms one on top of the other. Here we call .kjh-green[`geom_histogram()`] twice. What happens if you comment one or other of them out?
...
## .huge.right.bottom.squish4[.kjh-yellow[Avoid counting up,] .kjh-lblue[when necessary]]
