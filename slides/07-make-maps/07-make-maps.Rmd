...
---
`r chunk_reveal("reveal-bulldogmap", widths = c(35,65), title = "# First cut at a map")`
...
`r chunk_reveal("reveal-bulldogmap2", widths = c(35,65), title = "# Use a different palette")`
...
---
`r chunk_reveal("reveal-bulldogzeros", widths = c(35,65), title = "# Keep the Zero count zips")`
...
---
`r chunk_reveal("reveal-bulldogfb2", widths = c(35,65), title = "# Now redraw the map")`
