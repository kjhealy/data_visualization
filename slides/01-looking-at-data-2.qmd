---
title: "Data Visualization - 1. Looking at Data (b)"
...
![Color only, N = 20](img/01_preattentive_col_20.png){width=65%}
...
![Color only, N = 100](img/01_preattentive_col_100.png){width=65%}
...
![Shape only, N = 20](img/01_preattentive_shp_20.png){width=65%}
...
![Shape only, N = 100](img/01_preattentive_shp_100.png){width=65%}
...
![Color and Shape, N=100](img/01_preattentive_col_shp_100.png){width=65%}
