...
`r chunq_reveal("reveal-fredpivot",  lcolw="60", rcolw="40", smallcode = TRUE, title = "Pivot the data")`
...
`r chunq_reveal("reveal-fredts1",  lcolw="60", rcolw="40", smallcode = TRUE,  title = "Make two plots")`
...
`r chunq_reveal("reveal-patchwork",  lcolw="60", rcolw="40", smallcode = TRUE, title = "Combine with patchwork")`
...
`r chunq_reveal("reveal-yahoo",  lcolw="60", rcolw="40", smallcode = TRUE, title = "Option 1")`
...
`r chunq_reveal("reveal-yahooalt",  lcolw="60", rcolw="40", smallcode = TRUE, title = "Alternatively ...")`
...
`r chunq_reveal("reveal-debt",  lcolw="60", rcolw="40", smallcode = TRUE, title = "Debt Plot 1")`
...
`r chunq_reveal("reveal-debtalt",  lcolw="60", rcolw="40", smallcode = TRUE, title = "Alternatively, a kind of stacked bar chart")`
...
`r chunq_reveal("reveal-lineboom",  lcolw="60", rcolw="40", smallcode = TRUE, title = "Boomer Line Graph")`
...
`r chunq_reveal("reveal-auxinfo",  lcolw="60", rcolw="40", smallcode = TRUE, , title = "Aux Info Panel")`
...
`r chunq_reveal("reveal-auxinfo2",  lcolw="60", rcolw="40", title = "A little kludge")`
...
`r chunq_reveal("reveal-beemain",  lcolw="60", rcolw="40", title = "At last, the Beeplot")`
