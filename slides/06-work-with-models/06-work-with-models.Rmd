...
.SMALL[
```{r 06-work-with-models-1, message = TRUE}
...
.pull-right.w55[
```{r 06-work-with-models-2, echo=FALSE}
...
.pull-right.w55[
```{r 06-work-with-models-3, echo=FALSE}
  knitr::include_graphics(
...
# ... but we usually won't do this inside .kjh-lblue[`ggplot`] 
...
.pull-right.w55[
```{r 06-work-with-models-4, echo=FALSE}
  knitr::include_graphics(
...
```{r 06-work-with-models-11, echo = FALSE, fig.width=12, fig.height=7}
p_out
```
...
```{r 06-work-with-models-13 }
library(broom)
```

```{r 06-work-with-models-14 }
tidy(out)
```
...
.pull-right.w45[
```{r 06-work-with-models-17, echo=FALSE}
  knitr::include_graphics(
...
```{r 06-work-with-models-21, echo = FALSE, fig.width=15, fig.height=8}
p_out
```
...
```{r 06-work-with-models-27, echo=FALSE, fig.height=8, fig.width=15}
p_out
```
...
```{r 06-work-with-models-34 }
add_b(x = 10)
```

```{r 06-work-with-models-35 }
add_b(x = c(1, 99, 1000))
```
...
```{r 06-work-with-models-47, echo = FALSE}
...
```{r 06-work-with-models-53, echo = FALSE, fig.height=6, fig.width=15}
p_out
```
...
- When we have two arguments to feed a function we can use .kjh-green[`map2()`]. The general case is .kjh-green[`pmap()`], for passing along any number of arguments in a list.

```{r 06-work-with-models-56 }
out_tidy <- gapminder |>
    group_by(continent, year) |>
    nest() |> 
...
.pull-left[
```{r 06-work-with-models-57, fig.height=3, fig.width=6}
out_tidy$ggout[[8]]
```
]
...
.pull-right[
```{r 06-work-with-models-58, fig.height=3, fig.width=6}
out_tidy$ggout[[18]]
```
]
...
.pull-right.w60[
```{r 06-work-with-models-66, echo=FALSE}
  knitr::include_graphics(
...
# Trends in the .kjh-orange[`happy`] measure

```{r 06-work-with-models-70 }
out_hap <- gss_svy |> 
...
.pull-left.w45[
```{r codefig-gssaltfig, message=FALSE, fig.show="hide", fig.width=4.8, fig.height=4.5}
out_hap |>  
...
.pull-right.w55[
```{r 06-work-with-models-71, echo=FALSE}
  knitr::include_graphics(
...
```{r 06-work-with-models-72, echo = FALSE, fig.width=11, fig.height=6}
out_hap |>
  filter(happy == "Not Too Happy") |> 
  ggplot(mapping = aes(x = year, 
                       y = prop,
...
.pull-left.w45[
```{r codefig-barplotreplace, message=FALSE, fig.show="hide", fig.width=4.8, fig.height=4.5}
...
.pull-right.w55[
```{r 06-work-with-models-77, echo=FALSE}
  knitr::include_graphics(
...
```{r 06-work-with-models-79, echo = FALSE, fig.width=18, fig.height=6}
p_out
```
...
```{r 06-work-with-models-81, echo = FALSE, fig.width=12, fig.height=8}
p_out
```
