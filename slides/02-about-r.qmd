...
![Markdown document](img/02_lorem_covid_markdown.png){fig-align="center" width=90%}
...
![](img/02_function-masking.png){with=90%}
...
## 5. Vectors come in [types]{.fg-yellow}; Objects in [classes]{.fg-yellow}
...
- Lists can be internally heterogenous. Underneath, most complex R objects are some kind of list with different components.
