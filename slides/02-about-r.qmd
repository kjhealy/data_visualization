...
![](img/02_rstudio_dont_restore.png)

Go to Tools > Global Options > General and (1) _Uncheck_ the box labeled "Restore .RData into workspace at startup", (2) Select "never" for "Save workspace to .RData on exit"

## Consider not showing output inline

![](img/02_rstudio_uncheck_inline.png)

Go to Tools > Global Options > R Markdown and _uncheck_ the box labeled "Show output inline for all R Markdown Documents"
...
Objects are made of one or more **vectors**. A vector can, in effect, only have a single type: [integer]{.fg-lblue}, [double]{.fg-green}, [logical]{.fg-orange}, [character]{.fg-pink}, [factor]{.fg-blue}, date, etc. That is, vectors are "atomic".  Complex objects are mostly made of lists of vectors of different sorts. Or they are made of _nested_ lists of other simpler objects that are themselves ultimately made up of vectors.
...
:::: {.columns}
::: {.column width="40%"}
![](img/02_summary-tree-atomic.png){width=90%}
...
![](img/02_error_object_length_warning.png){width=50%}

![](img/02_error_missing_comma.png){width=50%}

![](img/02_error_extra_paren.png){width=50%}
...
![](img/02_gordon_assignment.png){width=100% fig-align="center"}
